...
public class CropImageActivity extends MonitoredActivity {
    ...
    private void saveOutput(Bitmap croppedImage) {
        if (saveUri != null) {
            ...
            values.put(MediaStore.Images.ImageColumns.DATA, getRealFilePath(this,saveUri));
            values.put(MediaStore.Images.ImageColumns.TITLE,
                    getRealFilePath(this,saveUri).substring(getRealFilePath(this,saveUri).lastIndexOf("/") + 1));
            ...
            setResultUri(getRealFilePath(this,saveUri));
        }
    ...
    private void setResultUri(String path) {
